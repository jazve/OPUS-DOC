...
OPUS（Optimized Prompt Universal System）是一个基于单一系统提示词架构的AI智能体框架。通过标准化的语法结构，可以快速构建专业领域的AI智能体。

### 核心特性

- **单一提示词架构**：用一个系统提示词定义完整的智能体
- **跨平台兼容**：支持ChatGPT、Claude、Gemini等主流AI模型
- **简单易用**：类Markdown语法，学习成本低
- **专业知识激活**：框架级优化，提升AI专业领域表现
- **模块化设计**：六大核心模块，灵活组合
